...
!define URL http://www.Bitnet.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/Bitnet.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\Bitnet-qt.exe
...
OutFile Bitnet-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/Bitnet-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/Bitnetd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\Bitnet.exe
